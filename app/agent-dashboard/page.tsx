  ...
  const quickActions = [
    {
      ...
      desc: 'Create a new listing with photos and details',
      icon: (
    ...
    },
    {
      ...
      desc: 'Review scheduled viewings from potential buyers',
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <rect width="18" height="18" x="3" y="4" rx="2" ry="2" />
          <line x1="16" x2="16" y1="2" y2="6" />
    ...
    },
    {
      ...
      desc: 'Direct chat with interested clients',
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    },
    {
      href: '/agent-profile',
      label: 'Agent Profile',
      desc: 'Manage your public contact info & credentials',
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    },
    {
      ...
      desc: 'Complete identity verification to stay approved',
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div style={{ marginBottom: '3.5rem' }}>
              ...
              >
                {quickActions.map((action) => (
                  ...
                  >
                    <div style={{ color: 'hsl(var(--primary))', marginBottom: '0.25rem', display: 'flex', alignItems: 'center' }}>{action.icon}</div>
